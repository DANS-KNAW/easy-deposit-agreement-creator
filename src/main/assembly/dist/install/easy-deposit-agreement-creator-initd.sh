#!/usr/bin/env bash
#  /etc/init.d/easy-deposit-agreement-creator
# chkconfig: 2345 92 58

### BEGIN INIT INFO
# Provides:          easy-deposit-agreement-creator
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Short-Description: Starts the easy-deposit-agreement-creator service
# Description:       This file is used to start the daemon
#                    and should be placed in /etc/init.d
### END INIT INFO

NAME="easy-deposit-agreement-creator"
EXEC="/usr/bin/jsvc"
APPHOME="/opt/dans.knaw.nl/$NAME"
JAVA_HOME="/usr/lib/jvm/jre"
CLASSPATH="$APPHOME/bin/$NAME.jar"
CLASS="nl.knaw.dans.easy.agreement.ServiceStarter"
ARGS=""
USER="$NAME"
