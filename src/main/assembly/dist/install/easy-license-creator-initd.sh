#!/usr/bin/env bash
#  /etc/init.d/easy-license-creator
# chkconfig: 2345 92 58

### BEGIN INIT INFO
# Provides:          easy-license-creator
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Short-Description: Starts the easy-license-creator service
...
CLASS="nl.knaw.dans.easy.license.ServiceStarter"
ARGS=""
USER="$NAME"
